...
$base_url = "https://".$_SERVER['HTTP_HOST'] ; //url base of site if you want only relative url leave empty

$upload_dir = '/public/uploads/pub/sources'; // path from base_url to upload base dir

$current_path = '../../../../../../../../../../public/uploads/pub/sources/'; // relative path from filemanager folder to upload files folder
$thumbs_path =  '../../../../../../../../../../../public/uploads/pub/thumbs/';         //relative path from filemanager folder to thumbs folder
