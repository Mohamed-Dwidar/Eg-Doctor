...
@section('content')
    <div class="card-header">
        <h4>{{ __('messages.add_new_doctor') }}</h4>
    </div>
        ...
        <div class="card-body">
            ...
            <div class="row mb-3">
                ...
                <div class="col-lg-4">
                    ...
                    <select class="form-select" id="zone_id" name="zone_id">
                        <option value="">{{ __('messages.select_city_first') }}</option>
                    </select>
                    @error('zone_id')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
            ...
            <div class="row mb-3">
                <div class="col-lg-4">
                    ...
                    <input type="number" step="any" class="form-control" id="address_latitude" name="address_latitude"
                        value="{{ old('address_latitude', 26.8206) }}">
                ...
                <div class="col-lg-4">
                    ...
                    <input type="number" step="any" class="form-control" id="address_longitude"
                        name="address_longitude" value="{{ old('address_longitude', 30.8025) }}">
            ...
            <div class="row mb-3">
                <div class="col-lg-12">
                    ...
                    <textarea class="form-control" id="more_info" name="more_info" rows="3">{{ old('more_info') }}</textarea>
                    @error('more_info')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="departments[]"
                                            ...
                                            @checked(collect(old('departments', []))->contains($department->id))>
