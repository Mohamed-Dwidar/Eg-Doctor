...
@section('content')
    <div class="card-header">
        <h4>{{ __('messages.update_video') }}</h4>
    </div>
        ...
        <div class="card-body">
            <div class="row mb-3">
                <div class="col-lg-12">
                    ...
                    <input type="text" class="form-control" id="title" name="title"
                        value="{{ old('title', $video->title) }}" placeholder="{{ __('messages.title') }}">
                    @error('title')
            ...
            <div class="row mb-3">
                <div class="col-lg-12">
                    <label class="form-label" for="description">{{ __('messages.description') }} <span
                            class="text-danger">*</span></label>
                    <textarea class="form-control tinymce" id="description" name="description" rows="8">{{ old('description', $video->description) }}</textarea>
                    @error('description')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="row mb-3">
                <div class="col-lg-4">
                    ...
                    <input type="text" class="form-control" id="youtube_code" name="youtube_code"
                        value="{{ old('youtube_code', $video->youtube_code) }}" placeholder="dQw4w9WgXcQ">
                    @error('youtube_code')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                <div class="col-lg-4">
                    ...
                    <input type="text" class="form-control" id="video_code" name="video_code"
                        value="{{ old('video_code', $video->video_code) }}">
                    @error('video_code')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                <div class="col-lg-4">
                    ...
                    <input type="text" class="form-control" id="img_url" name="img_url"
                        value="{{ old('img_url', $video->img_url) }}" placeholder="https://...">
                    @error('img_url')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="col-lg-12">
                    <div class="form-check">
                        ...
                        <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1"
                            @checked(old('is_active', $video->is_active))>
             ...
             <div class="row mb-3">
                <div class="col-lg-6">
                    ...
                    <input type="text" class="form-control" id="slug" name="slug"
                        value="{{ old('slug', $video->seo?->slug) }}" placeholder="{{ __('messages.slug') }}">
                    @error('slug')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="row mb-3">
                <div class="col-lg-12">
                    ...
                    <input type="text" class="form-control" id="meta_title" name="meta_title"
                        value="{{ old('meta_title', $video->seo?->meta_title) }}" placeholder="{{ __('messages.meta_title') }}">
                    @error('meta_title')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="row mb-3">
                <div class="col-lg-12">
                    ...
                    <textarea class="form-control" id="meta_description" name="meta_description" rows="3">{{ old('meta_description', $video->seo?->meta_description) }}</textarea>
            ...
            <div class="row mb-3">
                <div class="col-lg-12">
                    ...
                    <textarea class="form-control" id="meta_tag" name="meta_tag" rows="3">{{ old('meta_tag', $video->seo?->meta_tag) }}</textarea>
                    @error('meta_tag')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="row mb-3">
                <div class="col-lg-6">
                    ...
                    <textarea class="form-control" id="header_script" name="header_script" rows="3">{{ old('header_script', $video->seo?->header_script) }}</textarea>
                    @error('header_script')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                <div class="col-lg-6">
                    ...
                    <textarea class="form-control" id="footer_script" name="footer_script" rows="3">{{ old('footer_script', $video->seo?->footer_script) }}</textarea>
                    @error('footer_script')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
