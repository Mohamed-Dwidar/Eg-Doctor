...
@section('content')
    <div class="card-header">
        <h4>Edit Blog :: {{ $blog->name_ar }}</h4>
    </div>
    <form class="" method="POST" action='{{ route("admin.blogs.update") }}' enctype="multipart/form-data">
        @csrf
        ...
        <div class="card-body">
            ...
            <div class="row mb-3">
                <div class="col-lg-6">
                    ...
                    <input type="text" class="form-control" id="name_ar" name="name_ar"
                        value="{{ old('name_ar', $blog->name_ar) }}" placeholder="Blog Title (AR)">
                    @error('name_ar')
                ...
                <div class="col-lg-6">
                    ...
                    <input type="text" class="form-control" id="name_en" name="name_en"
                        value="{{ old('name_en', $blog->name_en) }}" placeholder="Blog Title (EN)">
                    @error('name_en')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="row mb-3">
                <div class="col-lg-12">
                    ...
                    <textarea class="form-control tinymce" id="description_ar" name="description_ar" rows="5">{{ old('description_ar', $blog->description_ar) }}</textarea>
            ...
            <div class="row mb-3">
                <div class="col-lg-12">
                    ...
                    <textarea class="form-control tinymce" id="description_en" name="description_en" rows="5">{{ old('description_en', $blog->description_en) }}</textarea>
            ...
            <div class="row mb-3">
                ...
                <div class="col-lg-2">
                    @if ($blog->image)
                        <img src="{{ $blog->imageFullPath }}" alt="{{ $blog->img_alt }}" class="img-fluid mt-2"
                ...
                <div class="col-lg-3">
                    ...
                    <input type="text" class="form-control" id="img_alt" name="img_alt"
                        value="{{ old('img_alt', $blog->img_alt) }}" placeholder="Image Alt">
                    @error('img_alt')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="row mb-3">
                <div class="col-lg-12">
                    ...
                    <input type="text" class="form-control" id="meta_title" name="meta_title"
                        value="{{ old('meta_title', $blog->seo->meta_title) }}" placeholder="Meta Title">
                    @error('meta_title')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="row mb-3">
                <div class="col-lg-12">
                    ...
                    <textarea class="form-control" id="meta_tag" name="meta_tag" rows="3">{{ old('meta_tag', $blog->seo->meta_tag) }}</textarea>
                    @error('meta_tag')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="row mb-3">
                <div class="col-lg-6">
                    ...
                    <textarea class="form-control" id="header_script" name="header_script" rows="3">{{ old('header_script', $blog->seo->header_script) }}</textarea>
                    @error('header_script')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                <div class="col-lg-6">
                    ...
                    <textarea class="form-control" id="footer_script" name="footer_script" rows="3">{{ old('footer_script', $blog->seo->footer_script) }}</textarea>
                    @error('footer_script')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
